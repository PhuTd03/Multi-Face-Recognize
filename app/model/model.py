...
import sys
sys.path.append('/Users/user/Code_Space/FPT code/2023/Summer2023/DPL302m/Multi-Face-Recognize/src')  # Add the directory to the module search path
import convfacenet
import pickle
...
with open('/Users/user/Code_Space/FPT code/2023/Summer2023/DPL302m/Multi-Face-Recognize/data/database.pickle', 'rb') as file:
    serialized_data = file.read()
database = pickle.loads(serialized_data)

def predict_pipeline(frame, threshold=0.6):
