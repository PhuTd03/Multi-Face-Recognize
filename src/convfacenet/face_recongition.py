...
import sys
sys.path.append('/Users/user/PycharmProjects/Code_Space/2023/Summer2023/DPL302m/Multi-Face-Recognize/src')
from convfacenet.face_detection import *
from convfacenet.face_descriptor.models import FaceDescriptorModel
...
def load_descriptor_model_weights(model):
    ...
    weights_path = "/Users/user/Code_Space/FPT code/2023/Summer2023/DPL302m/Multi-Face-Recognize/app/model/model_weights/final_weights/face_descriptor.pth"
    if not os.path.exists(weights_path):
        if not os.path.exists(
                "/Users/user/Code_Space/FPT code/2023/Summer2023/DPL302m/Multi-Face-Recognize/app/model/model_weights"):
            os.mkdir(
                "/Users/user/Code_Space/FPT code/2023/Summer2023/DPL302m/Multi-Face-Recognize/app/model/model_weights")
        if not os.path.exists(
                "/Users/user/Code_Space/FPT code/2023/Summer2023/DPL302m/Multi-Face-Recognize/app/model/model_weights/final_weights"):
            os.mkdir(
                "/Users/user/Code_Space/FPT code/2023/Summer2023/DPL302m/Multi-Face-Recognize/app/model/model_weights/final_weights")
