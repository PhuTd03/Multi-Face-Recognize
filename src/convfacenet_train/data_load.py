...
import sys
sys.path.append('/Users/user/PycharmProjects/Code_Space/2023/Summer2023/DPL302m/Multi-Face-Recognize/src/convfacenet_train')  # Add the directory to the module search path
